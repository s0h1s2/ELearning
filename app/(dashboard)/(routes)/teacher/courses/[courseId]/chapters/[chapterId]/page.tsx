...
const ChapterId = async ({ params }: { params: { courseId: string, chapterId: string } }) => {
  ...
  return (
    <>
      {!chapter.isPublished && (
        <Banner content="Chapter is not published. It will not be visible" />
      )}
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="w-full">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <ChapterActions disabled={!isChapterComplete} courseId={params.courseId} chapterId={params.chapterId} isPublished={chapter.isPublished} />
            </div>
          </div>
        </div>
